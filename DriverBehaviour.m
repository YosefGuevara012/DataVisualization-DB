...
% Last Modified by GUIDE v2.5 10-Mar-2020 15:12:00
...
estrellas_del_viaje = (1 - (puntaje_total/puntos_max_permitidos_viaje))*5
porcentaje_del_viaje = estrellas_del_viaje * 20 % 100 / 5
...
title('Resultado de la calificación por estrellas (*).')
xlim([0 100])
ylim([0 5])
